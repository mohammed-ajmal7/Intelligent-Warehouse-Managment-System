...
class BillClass:
    def __init__(self, root):
        ...
        title = Label(self.root, text="SMART WAREHOUSE MANAGEMENT", image=self.icon_title, compound=LEFT, font=("times new roman", 40, "bold"), bg="#010c48", fg="white", anchor="w", padx=20)
        ...
        # Clock
        self.lbl_clock = Label(self.root, text="Welcome to SMART WAREHOUSE MANAGEMENT\t\t Date:DD-MM-YYYY\t\t Time:HH:MM:SS", font=("times new roman", 15), bg="#4d636d", fg="white")
...
###########billing area#################
        ...
        ################footer#############
        footer=Label(self.root,text="SMART WAREHOUSE MANAGEMENT | DEVELOPED BY KUSUMANJALI AND SNEHA PRIYA",font=("times new roman",11),bg="#4d636d",fg="white",bd=0,cursor="hand2").pack(side=BOTTOM,fill=X)
        self.show()
        #self.bill_top()
...
#############all functions###############
    ...
    def add_update_cart(self):
     if self.var_pid.get() == '':
        ...
        messagebox.showerror('Error', "Product insufficient", parent=self.root)
